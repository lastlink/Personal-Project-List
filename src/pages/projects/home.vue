<template>
  <f7-page>
    <f7-navbar>
      ...
      <f7-nav-title>Personal Projects</f7-nav-title>
      <f7-nav-right>
    ...
    <f7-list class="searchbar-hide-on-search">
      <f7-list-item title="About" link="/about/">
        <f7-icon slot="media" material="collections_bookmark"></f7-icon>
      </f7-list-item>
    </f7-list>

    <f7-block-title class="searchbar-found">Components</f7-block-title>
    <f7-list class="components-list searchbar-found">
      <f7-list-item link="/home-list/" title="Home Websites">
        <f7-icon slot="media" material="vpn_lock"></f7-icon>
        <!-- <f7-icon icon="icon-home"></f7-icon> -->
        <!-- <f7-icon slot="media" icon="icon-f7"></f7-icon> -->

      </f7-list-item>
      <f7-list-item link="/live-list/" title="Live Websites">
        <f7-icon slot="media" material="network_wifi"></f7-icon>
      </f7-list-item>
      <f7-list-item link="/github-list/" title="Github Projects">
        <f7-icon slot="media" material="code"></f7-icon>
      </f7-list-item>
      <f7-list-item link="/games-list/" title="Games">
        <f7-icon slot="media" material="videogame_asset"></f7-icon>
      </f7-list-item>
